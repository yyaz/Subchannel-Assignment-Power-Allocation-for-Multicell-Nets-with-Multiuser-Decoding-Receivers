function [Used,rate1] = SCA_case2(BS,H,p,rate,Pt_max,Z,Rmin,U,S)
...
H11_temp= H(BS,BS,:,:)./max(H(otherBS1,BS,:,:),H(otherBS2,BS,:,:));
...
rate(BS,s) = calcrateSC_rateregion_case2(BS,H(:,BS,Used(1,s),s),p(:,s),rate(:,s),Z);
