function [p1,rate1] = SubgradProj_Shen(BS,H,p,rate,Pt_max,Pt_max_vector,Used,Z,Rmin,S)
...
for s= 1:S
    q_BS1=x1(Used(1,s)+1);
    [p(BS,s),rate(BS,s)] = calc_power_rateSC_Shen(BS,H(:,BS,Used(1,s),s),p(:,s),rate(:,s),Z,q_BS1,lambda_opt11);
